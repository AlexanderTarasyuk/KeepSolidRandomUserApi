package com.example.user.provectus.mvp.View.Adapter;
...
import com.example.user.provectus.mvp.View.UserDetailsActivity;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof UsersViewHolder) {
            ...
            contactHolder.linearLayoutContainer.setOnClickListener(v -> {
                ...
                ((Activity) context).overridePendingTransition(R.animator.exit, R.animator.entry);
            });
        }
